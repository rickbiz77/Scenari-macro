...
export default function App(){
  ...
  return <div style={{minHeight:"100vh",background:"#080812",color:"#e2e8f0",fontFamily:"system-ui,sans-serif",padding:16}}>
    ...
    {tab==="radar"&&(()=>{
      ...
      const HOT_MAX=80,COLD_MIN=50; // TOP HOT: score sotto 80, ordinati per EMERGENTE (variazione alta + score basso); TOP COLD: score 50 o piu'
      ...
      const cold=valid.filter(e=>e._tf<0&&e.score!=null&&e.score>=COLD_MIN).map(e=>({...e,emrg:e._tf*((e.score??50))/100})).sort((a,b)=>a.emrg-b.emrg).slice(0,15);
      ...
      return <div style={{display:"flex",flexDirection:"column",gap:16}}>
        ...
        <div>
          <div style={{background:"#0f172a",border:"1px solid rgba(239,68,68,0.3)",borderRadius:8,padding:"8px 12px",marginBottom:8}}>
            ...
            <div style={{fontSize:8,color:"#6b7280"}}>Salgono più forte ma con score ancora basso (sotto 80) — ordinati per variazione alta + score basso</div>
          </div>
          {hot.length===0
